export default function Testimonials() {
  const testimonials = [
    ...
    },
    {
      name: 'Alice K.',
      role: 'Étudiante',
      content: "Des prix abordables pour une qualité incroyable. De plus, j'ai adoré l'expérience d'achat sur mobile, c'est tellement fluide et rapide.",
      initials: 'AK',
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -mr-32 -mt-32 w-96 h-96 bg-primary-500/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 -ml-32 -mb-32 w-96 h-96 bg-secondary-500/10 rounded-full blur-3xl pointer-events-none" />

      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Ils nous font <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-600 to-secondary-600">Confiance</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, idx) => (
            <div
              key={idx}
              className="bg-white/80 dark:bg-dark-card/80 backdrop-blur-lg border border-gray-100 dark:border-white/5 rounded-3xl p-8 shadow-soft hover:shadow-glow-secondary transition-all duration-300 relative group"
            >
